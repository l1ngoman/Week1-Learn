...
function hasNumber(string){
  for (var i=0; i < string.length; i++){
    for(var j=0; j < 10; j++){
      if(string[i] == j){
        console.log(`string: ${string[i]}, counter: ${j}`);
        return false;
      }
    }
  }
...
// //6. User ID MUST 6 or more characters
// //7. Password MUST be 6 or more characters
// var alerts = {alr1: "User ID can't include !, #, or $",}
//
